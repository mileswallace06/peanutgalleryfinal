...
export default function BetaDashboard() {
  ...
  if (!isAdmin(user)) return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-4 px-6 text-center">
      <p className="font-bold text-foreground">{isLoadingAuth ? 'Checking access…' : 'Admin only'}</p>
  ...
  return <div className="min-h-screen pb-32" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
    <nav aria-label="Beta dashboard sections" className="flex gap-3 px-4 pt-16 pb-2">

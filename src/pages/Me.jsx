        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-xs dark:text-[rgba(0,200,255,0.85)]" style={{ color: '#002847' }}>View your purchases</div>
            </div>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-xs dark:text-[rgba(191,95,255,0.85)]" style={{ color: '#4A2D5F' }}>Track your listings</div>
            </div>
            <ChevronRight className="w-4 h-4 text-muted-foreground" />
          </Link>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-xs dark:text-[rgba(0,255,135,0.85)]" style={{ color: '#003D24' }}>List seats you want to move</div>
            </div>
            <ChevronRight className="w-4 h-4 text-muted-foreground" />
          </Link>
          ...
          {user.role === 'admin' && (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-xs dark:text-[rgba(255,230,0,0.85)]" style={{ color: '#4D3300' }}>Manage events and listings</div>
              </div>
              <ChevronRight className="w-4 h-4 text-muted-foreground" />
            </Link>
          )}

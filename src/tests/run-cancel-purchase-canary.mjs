/**
 * Wrapper for cancel-purchase-canary.test.mjs — registers npm-compat hook,
...
const harness = await import(pathToFileURL('./tests/cancel-purchase-canary.test.mjs').href);
...
console.log('═══════════════════════════════════════════════════════════════════');
console.log('  Cancel-Purchase Canary Suite');
console.log('═══════════════════════════════════════════════════════════════════');

    ...
    <div className="px-4 space-y-3">
      ...
      style={{ background: 'hsl(var(--card))', border: '1px solid rgba(191,95,255,0.2)' }}>
        ...
        <div className="flex gap-2">
          ...
          className="flex-1 flex items-center justify-center gap-2.5 py-3 rounded-2xl font-bold text-sm transition-all active:scale-[0.98]"
          ...
          <button onClick={onEnterCity}
          className="flex-1 flex items-center justify-center gap-2.5 py-3 rounded-2xl font-semibold text-sm transition-all active:scale-[0.98]"

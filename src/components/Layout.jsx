...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen rave-bg font-sans">
      {/* Black banner at top */}
      <div className="fixed top-0 left-0 right-0 h-24 bg-black z-[99]" />
      
      {/* Logo */}
      <Link to="/" className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-center pointer-events-auto h-40">
        <img
